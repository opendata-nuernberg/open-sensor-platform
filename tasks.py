...
def flash_firmware(c):
    ...
    c.run(
        f"esptool.py --chip esp32c3 -b 460800 --before default_reset --after hard_reset write_flash --flash_mode dio --flash_size 2MB --flash_freq 80m 0x0 {bootloader} 0x8000 {partition_table} 0x10000 {firmware}"
    )
